...
export default class Character {
  constructor({ x = 120, groundY = 380, width = 90, height = 140 } = {}) {
    ...
    const jumpRisePaths = [`${base}/3_jump/J-34.png`];
    ...
    const jumpFallPaths = [`${base}/3_jump/J-37.png`];

    const jumpLandPaths = [`${base}/3_jump/J-38.png`];

    const jumpStandPaths = [`${base}/3_jump/J-39.png`];
